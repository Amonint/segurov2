    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            with transaction.atomic():
                ...
                if not client_user:
                    client_user = UserProfile.objects.create_user(
                        username="cliente1",
                ...
                adjuster_user = UserProfile.objects.filter(
                    username="ajustador1"
                ).first()
                if not adjuster_user:
                    adjuster_user = UserProfile.objects.create_user(
                        username="ajustador1",
                ...
                policy_vh, _ = Policy.objects.get_or_create(
                    ...
                    defaults={
                        ...
                        "status": "active",
                        "insured_value": Decimal("45000.00"),
                        "prima": Decimal("1200.00"),
                        "coverage_description": "Cobertura completa",
                        "objeto_asegurado": "Toyota Fortuner 2024",
                ...
                policy_pr, _ = Policy.objects.get_or_create(
                    ...
                    defaults={
                        ...
                        "status": "active",
                        "insured_value": Decimal("120000.00"),
                        "prima": Decimal("2500.00"),
                        "coverage_description": "Todo riesgo",
                        "objeto_asegurado": "Departamento Centro",
                        "responsible_user": admin_user,
                    },
                )
                ...
                asset_veh, _ = Asset.objects.get_or_create(
                    ...
                    defaults={
                        ...
                        "is_insured": True,
                        "custodian": client_user,
                        "responsible_user": client_user,
                ...
                asset_prop, _ = Asset.objects.get_or_create(
                    ...
                    defaults={
                        ...
                        "description": "Departamento 3 dormitorios",
                        "location": "Guayaquil",
                        "acquisition_cost": Decimal("110000.00"),
                ...
                claim1, created1 = Claim.objects.get_or_create(
                    ...
                    defaults={
                        "policy": policy_vh,
                        "asset": asset_veh,
                        "reportante_id": client_user.id,
                        "reported_by": client_user,
                        "fecha_siniestro": "2025-06-15",
                        "incident_date": "2025-06-15",
                        "incident_description": "Choque lateral leve",
                        "causa": "Colisión",
                        "ubicacion_detallada": "Av. Shyris",
                        "incident_location": "Av. Shyris",
                        "status": "pendiente",
                        "estimated_loss": Decimal("1500.00"),
                        "asset_type": "vehiculo",  # Fixed choice (must match asset.asset_type usually, or just string)
                        "asset_description": "Toyota Fortuner",
                        "asset_code": "VEH-001",
                    },
                )
                ...
                claim2, created2 = Claim.objects.get_or_create(
                    ...
                    defaults={
                        ...
                        "reportante_id": client_user.id,
                        "reported_by": client_user,
                        "fecha_siniestro": "2025-07-20",
                        "incident_date": "2025-07-20",
                        "incident_description": "Rotura tubería",
                        "causa": "Daño por agua",
                        "ubicacion_detallada": "Edif Torre",
                        "incident_location": "Edif Torre",
                        "status": "en_revision",
                        "estimated_loss": Decimal("850.00"),
                        "asset_type": "otros",  # Fixed choice
                        "asset_description": "Departamento",
                        "asset_code": "PROP-001",
                    },
                )
                ...
                inv1, _ = Invoice.objects.get_or_create(
                    ...
                    defaults={
                        ...
                        "superintendence_contribution": Decimal("42.00"),
                        "farm_insurance_contribution": Decimal("6.00"),
                        "emission_rights": Decimal("0.00"),
                        "tax_base": Decimal("1248.00"),
                        "iva": Decimal("187.20"),
                        "payment_status": "paid",
