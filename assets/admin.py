...
class AssetAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            _("Especificaciones"),
            {"fields": ("brand", "model", "serial_number"), "classes": ("collapse",)},
        ),
        (
            _("Información financiera"),
            {"fields": ("acquisition_date", "acquisition_cost", "current_value")},
        ),
        (_("Estado y condición"), {"fields": ("condition_status",)}),
        (_("Responsables"), {"fields": ("custodian", "responsible_user")}),
        (
            _("Seguro"),
            {"fields": ("is_insured", "insurance_policy"), "classes": ("collapse",)},
        ),
        (
    ...
    update_current_values.short_description = _(
        "Actualizar valores actuales de los activos seleccionados"
    )
