...
class AuditLog(models.Model):
    ...
    action_type = models.CharField(
        _("Tipo de acción"), max_length=20, choices=ACTION_TYPE_CHOICES
    )

    entity_type = models.CharField(
        _("Tipo de entidad"), max_length=20, choices=ENTITY_TYPE_CHOICES
    )

    entity_id = models.CharField(
        _("ID de la entidad"), max_length=100, help_text=_("ID de la entidad afectada")
    )
    ...
    description = models.TextField(
        _("Descripción"), help_text=_("Descripción detallada de la acción realizada")
    )
    ...
    def __str__(self):
        ...
        return (
            f"{user_name} - {self.action_type} - {self.entity_type} ({self.created_at})"
        )
