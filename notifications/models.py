...
class EmailLog(models.Model):
    ...
    @staticmethod
    def send_email(template_type, recipient_email, recipient_name='', context=None,
                   claim=None, policy=None, invoice=None, created_by=None):
        """
...
class Alert(models.Model):
    ...
    email_recipients = models.TextField(
        _('Emails adicionales'),
        blank=True,
        help_text=_('Emails separados por comas')
    )
    ...
    def get_email_list(self):
        ...
        if self.email_recipients:
            additional_emails = [email.strip() for email in self.email_recipients.split(',')]
