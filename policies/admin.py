...
class PolicyAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_("Clasificación"), {"fields": ("group_type", "subgroup", "branch")}),
        (_("Fechas"), {"fields": ("start_date", "end_date", "issue_date")}),
        (_("Información financiera"), {"fields": ("insured_value",)}),
        (
            _("Descripciones"),
            {
...
class PolicyDocumentAdmin(admin.ModelAdmin):
    ...
    def get_queryset(self, request):
        ...
        Optimize queryset with select_related
        """
        return super().get_queryset(request).select_related("policy", "uploaded_by")
