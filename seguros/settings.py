...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-!4d@nx0m^-#*69%m12^^#hfu3=&&x^&3ima(h^elk4xan$&c98')
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "accounts.context_processors.user_permissions",  # Custom context processor
            ],
        },
    },
]
...
DATABASES = {
    "default": {
        ...
        "PASSWORD": config('DB_PASSWORD', default='seguros_pass'),
...
LANGUAGE_CODE = "es-ec"  # Spanish (Ecuador)
