"""
Working Django Management Command to populate database with test data.
"""
    ...
    def handle(self, *args, **options):
        ...
        try:
            with transaction.atomic():
                ...
                self.stdout.write(
                    self.style.SUCCESS(f"✓ {len(policies)} pólizas creadas")
                )
    ...
    def create_claims(self, assets, users):
        ...
        for i in range(10):
            ...
            claim = Claim.objects.create(
                ...
                incident_description="Daño reportado en el equipo",
